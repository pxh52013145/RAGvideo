...
const KnowledgePage = () => {
  ...
  useEffect(() => {
    if (syncItems.length === 0 && !syncLoading) {
      syncScan({ silent: true })
    }
  }, [syncItems.length, syncLoading, syncScan])
          ...
          <div className="relative flex-1 overflow-y-auto">
            <div className="p-4 space-y-2">
              <div className="pb-2">
                ...
                {syncProfile ? <div className="mt-2 text-[11px] text-slate-500">当前方案：{syncProfile}</div> : null}
              </div>
